function [anova_tab,multicomp_tab1,multicomp_tab2, multicomp_tab12] = TwowayAnova_Behavioural_YoungvsElderlyvsMCI(YoungData, HealthyOldData, MCIMergedData, config)
...
[MCIY, MCIGroupNames, MCIConditionNames]=ReGroupData(MCIMergedData,'MCI');

AllY              = [YoungY,             HealthyOldY,             MCIY];
AllGroupNames     = [YoungGroupNames,    HealthyOldGroupNames,    MCIGroupNames];
AllConditionNames = [YoungConditionNames,HealthyOldConditionNames,MCIConditionNames];
