function [negloglikelihood] = EstimateG1G2(G1, G2, G3, g2, g3, b, sigma, nu, Input, config)
%EstimateG1G2 means two different discount on two legs
%   Args:
%       G1 is the gain of the length of leg 1
%       G2 is the gain of the length of leg 2
%       G3 is the gain of the length of leg 3
