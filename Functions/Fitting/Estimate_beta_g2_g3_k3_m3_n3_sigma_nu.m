function [negloglikelihood] = Estimate_beta_g2_g3_k3_m3_n3_sigma_nu(beta, g2, g3, k3, m3, n3, sigma, nu, Input, config)
...
%       n3 is the repferred return angle (measuring production error)
...
for tr = 1:sampleSize
    ...
    l3_prime    = m3*h+n3*(1-m3);    %regress to mean correct return distance
