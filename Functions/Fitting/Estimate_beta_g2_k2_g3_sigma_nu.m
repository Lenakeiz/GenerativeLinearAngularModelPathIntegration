function [negloglikelihood] = Estimate_beta_g2_k2_g3_sigma_nu(beta, g2, k2, g3, sigma, nu, Input, config)
...
%       k2 is teh regression to mean value for the encoding angle
