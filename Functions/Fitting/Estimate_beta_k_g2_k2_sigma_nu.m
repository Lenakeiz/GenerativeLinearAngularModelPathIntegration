function [negloglikelihood] = Estimate_beta_k_g2_k2_sigma_nu(beta, k, g2, k2, sigma, nu, Input, config)
%   find the likelihood of the beta - k- g2 - sigma - nu Model
%   Args:
%       beta is the leaky decay factor for the mental distance
%       k the velocity gain
%       g2 is the rotation gain for the second turn (measuring encoding error)
%       k2 regression to mean value
...
for tr = 1:sampleSize
    ...
    theta2_prime = g2*theta2+k2*(1-g2);
