...
function [anova_tab,multicomp_tab1,multicomp_tab2, multicomp_tab12] = TwowayAnova_CocoModel(AllPos, AllNeg, config)
    ...
    for param_idx=1:param_nums
        ...
        [PosY, PosGroupNames, PosConditionNames]=GroupAndRemoveNaN(AllPos,param_idx,'ApoePos');
        [NegY, NegGroupNames, NegConditionNames]=GroupAndRemoveNaN(AllNeg,param_idx,'ApoeNeg');
