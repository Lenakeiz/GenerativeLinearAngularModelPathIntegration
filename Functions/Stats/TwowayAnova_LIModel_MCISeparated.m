...
function [anova_tab,multicomp_tab1,multicomp_tab2, multicomp_tab12] = TwowayAnova_LIModel_MCISeparated(AllYoung, AllHealthyOld, AllMCIPos, AllMCINeg, AllMCIUnk, config)
