...
function plotLeg2(AllParams, AllDX, config)
    ...
    for TRIAL_FILTER=1:numConds
        ...
        set(gca, ...
            ...
            'YColor'      , [.1 .1 .1], ...
            'XTick'       , [1,2],... 
            'XTickLabel'  , {'Physical leg 2','Mental leg 2'},...
        ...
        exportgraphics(f,config.ResultFolder+"/Leg2Change"+conditionName{TRIAL_FILTER}+".pdf",'Resolution',300, 'ContentType','vector');
    end
end
