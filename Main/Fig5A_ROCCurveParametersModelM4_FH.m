...
config.ResultFolder = pwd + "/Output/ModelFigures/ROC_FH_M4";
...
legendText{1,1} = "AUC(" + convertCharsToStrings({'\beta g_2 \sigma \nu'}) + ") = " + num2str(round(AUC{1}.Value(1),2),2);

disp("AUC(" + convertCharsToStrings({'\beta g_2 \sigma \nu'}) + ") CI = [" ...
