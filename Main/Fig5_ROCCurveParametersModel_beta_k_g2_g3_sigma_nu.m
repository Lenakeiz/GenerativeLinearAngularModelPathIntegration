...
config.ResultFolder = pwd + "/Output//PaperFigs/Fig5A/ModelParameters/beta_k_g2_g3_sigma_nu";
...
colors = config.color_scheme_npg([8 3 7 9 10 2],:);
...
for i = 1:length(parametersName)
    AUC = plotROCCurveSVM(params1(:,i), params2(:,i), params1groupName, params2groupName, colors(i,:));
