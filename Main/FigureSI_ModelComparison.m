...
%% 1, beta, k, g2, g3, sigma, nu Model --> encoding errors in distance and angles and production error in angle
...
[beta_k_g2_g3_sigma_nu_AIC, beta_k_g2_g3_sigma_nu_BIC,beta_k_g2_g3_sigma_nu_NLL] = reformatIC(beta_k_g2_g3_sigma_nu_IC, "all");

%% 2, beta, g2, g3, sigma, nu Model --> encoding errors in distance and angles and production error in angle
...
%% 3, beta, k, g2, g3, sigma, nu Model --> encoding errors in distance and angles and production error in angle
...
%%
config.ResultFolder = pwd+"/Output/ModelFigures/ModelComparison_HC_SI";
