...
resultfolder = pwd + "/Output/ModelFigures/DoublePos_DoubleNeg_"+config.ModelName;
...
%% ThreewayAnova
config.Gender_Pos = DoublePos.Gender;
config.Gender_Neg = DoubleNeg.Gender;
[anova_tab,multicomp_tab1,multicomp_tab2, multicomp_tab3, multicomp_tab12] = ThreewayAnova_CocoData(AllDoublePosParams, AllDoubleNegParams, config);
