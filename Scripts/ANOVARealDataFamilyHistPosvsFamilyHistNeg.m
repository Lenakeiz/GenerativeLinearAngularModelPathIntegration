...
%%
[~, FHPosX, FHPosDX, FHPosTheta, FHPosDistErr, FHPosAngleErr,~] = getResultsAllConditions(FamilyHistPos, config);
...
%%
[~, FHNegX, FHNegDX, FHNegTheta, FHNegDistErr, FHNegAngleErr, ~] = getResultsAllConditions(FamilyHistNeg, config);
