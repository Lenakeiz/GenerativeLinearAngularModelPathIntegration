...
config.ResultFolder = pwd + "/Output/DataFigures/ROC_FH";
...
%%
FHNegDistanceError          = averageAcrossConditions(FamilyHistNeg.Results.DistErr);
FHPosDistanceError          = averageAcrossConditions(FamilyHistPos.Results.DistErr);

FHNegAngErr                 = averageAcrossConditions(FamilyHistNeg.Results.AngleErr);
FHPosAngErr                 = averageAcrossConditions(FamilyHistPos.Results.AngleErr);

%
allParamsFHPos    = [FHPosDistanceError FHPosAngErr];
allParamsFHNeg    = [FHNegDistanceError FHNegAngErr];
...
generateROCCurve(allParamsFHNeg, allParamsFHPos,'FHneg', 'FHpos', parametersName, config, plotInfo);
