...
exportgraphics(currFig,config.ResultFolder+"/OutboundPathLengthSeparateMCI.png",'Resolution',300);
exportgraphics(currFig,config.ResultFolder+"/OutboundPathLengthSeparateMCI.pdf",'Resolution',300, 'ContentType','vector');
...
MCIAllData = [MCIUnkOutbound; MCINegOutbound; MCIPosOutbound];
...
OutboundData = [YoungOutbound HealthyControlsOutbound MCIAllData];
...
%
OutboundDataAnova = [YoungOutbound; HealthyControlsOutbound; MCIAllData];
OutboundDataAnovaGroups = [repmat({'Young'}, size(YoungOutbound, 1), 1); ...
          repmat({'Healthy Older'}, size(HealthyControlsOutbound, 1), 1); ...
...
exportgraphics(currFig,config.ResultFolder+"/OutboundPathLengthPooledMCI.png",'Resolution',300);
exportgraphics(currFig,config.ResultFolder+"/OutboundPathLengthPooledMCI.pdf",'Resolution',300, 'ContentType','vector');
